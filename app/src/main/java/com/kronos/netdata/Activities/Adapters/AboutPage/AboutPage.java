package com.kronos.netdata.Activities.Adapters.AboutPage;
 ...
 * in an activity's {@link android.app.Activity#} method
 * <p>
...
public class AboutPage {
    ...
    public AboutPage addEmail(String email, String title) {
        ...
        emailElement.setIconTint(R.color.about_youtube_color);
        emailElement.setIconNightTint(R.color.about_youtube_color);
    ...
    public AboutPage addFacebook(String id, String title) {
        ...
        facebookElement.setIconNightTint(R.color.about_facebook_color);
    ...
    public AboutPage addTwitter(String id, String title) {
        ...
        twitterElement.setIconNightTint(R.color.about_twitter_color);
    ...
    /**
     * Convenience method for {@link AboutPage#addTelegram(String, String)} but with
     * a predefined title string
     *
     * @param id the Telegram group id to display
     * @return this AboutPage instance for builder pattern support
     */
    ...
    public AboutPage addTelegram(String id, String title) {
        ...
        if (AboutPageUtils.isAppInstalled(mContext, "org.telegram.messenger")) {
            ...
            intent.setData(Uri.parse("tg://resolve?domain=netdata_chat"));
        } else {
            intent.setData(Uri.parse("https://t.me/joinchat/netdata_chat"));
        }
    ...
    public AboutPage addPlayStore(String id, String title) {
        ...
        playStoreElement.setIconNightTint(R.color.about_play_store_color);
    ...
    public AboutPage addYoutube(String id, String title) {
        ...
        youtubeElement.setIconNightTint(R.color.about_youtube_color);
    ...
    public AboutPage addInstagram(String id, String title) {
        ...
        instagramElement.setIconNightTint(R.color.about_instagram_color);
    ...
    public AboutPage addGitHub(String id, String title) {
        ...
        gitHubElement.setIconNightTint(R.color.about_github_color);
    ...
    public AboutPage addWebsite(String url, String title) {
        ...
        websiteElement.setIconTint(R.color.primaryLight);
        websiteElement.setIconNightTint(R.color.primaryLight);
