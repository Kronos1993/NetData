...
public class MainActivityDrawer extends AppCompatActivity
    ...
    private RecyclerView gridViewActions;
    ...
    private void initViews() {
        ...
        gridViewActions = (RecyclerView) findViewById(R.id.gridview);
        gridViewActions.setHasFixedSize(false);
        set3Gor4G();
        if (sharedPreferences.getBoolean("list", true)) {
            if (is3GOr4G(navigationView.getMenu())) {
                if (actionList.isEmpty()) {
                    ...
                    adapterGridOrList = new PaqueteInternetAdapterGridOrList(context, true);
                    adapterGridOrList.submitList(actionList);
                    gridViewActions.setLayoutManager(new LinearLayoutManager(context));
                ...
                if (actionList4G.isEmpty()) {
                    ...
                    adapterGridOrList = new PaqueteInternetAdapterGridOrList(context, true);
                    adapterGridOrList.submitList(actionList4G);
                    gridViewActions.setLayoutManager(new LinearLayoutManager(context));
                    gridViewActions.setVisibility(View.VISIBLE);
                    textViewNoDataGrid.setVisibility(View.GONE);
                }
            ...
            if (is3GOr4G(navigationView.getMenu())) {
                if (actionList.isEmpty()) {
                    ...
                    adapterGridOrList = new PaqueteInternetAdapterGridOrList(context, false);
                    adapterGridOrList.submitList(actionList);
                    gridViewActions.setLayoutManager(new GridLayoutManager(context, Integer.parseInt(sharedPreferencesSetings.getString("row_list", "2"))));
                    gridViewActions.setVisibility(View.VISIBLE);
                    textViewNoDataGrid.setVisibility(View.GONE);
                }
            } else {
        ...
        if (adapterGridOrList != null) {
            ...
            adapterGridOrList.setOnItemClickListener(new PaqueteInternetAdapterGridOrList.OnItemClickListener() {
                @Override
                public void onItemClick(PaqueteInternet paqueteInternet) {
                    createConfirmDialog(paqueteInternet);
                }
            });
        } else {
        ...
        if (as.equalsIgnoreCase("list")) {
            if (is3GOr4G(navigationView.getMenu())) {
                if (actionList.isEmpty()) {
                    ...
                    adapterGridOrList.setList(true);
                    adapterGridOrList.submitList(actionList);
                    gridViewActions.setLayoutManager(new LinearLayoutManager(context));
                    adapterGridOrList.notifyDataSetChanged();
                    gridViewActions.setVisibility(View.VISIBLE);
                    textViewNoDataGrid.setVisibility(View.GONE);
                }
            } else {
            ...
            if (is3GOr4G(navigationView.getMenu())) {
                if (actionList.isEmpty()) {
                    ...
                    adapterGridOrList.setList(false);
                    adapterGridOrList.submitList(actionList);
                    gridViewActions.setLayoutManager(new GridLayoutManager(context, Integer.parseInt(sharedPreferencesSetings.getString("row_list", "2"))));
                    adapterGridOrList.notifyDataSetChanged();
                    gridViewActions.setVisibility(View.VISIBLE);
